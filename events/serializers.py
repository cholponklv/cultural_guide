...
class EventsSerializer(serializers.ModelSerializer):
    category_titles = serializers.StringRelatedField(
        source='category.all', many=True)

    class Meta:
        model = models.Events
        fields = ('id', 'title', 'category', 'category_titles', 'photo', 'description', 'price',
                  'date', 'time_start', 'time_end', 'views', 'priority', 'geolocation_name', 'organizer')


class EventsCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.Events
        fields = ('id', 'title', 'category', 'photo', 'description', 'price', 'date',
